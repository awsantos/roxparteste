...
CREATE TABLE SalesOrderDetail (
                ...
                UnitPrice NUMERIC(25) NOT NULL,
                UnitPriceDiscount NUMERIC(25) DEFAULT 0 NOT NULL,
...
CREATE TABLE Product (
                ...
                StandardCost NUMERIC(25) DEFAULT 0 NOT NULL,
...
CREATE TABLE SalesOrderHeader (
                ...
                SubTotal NUMERIC(25) DEFAULT 0 NOT NULL,
                TaxAmt NUMERIC(25) DEFAULT 0 NOT NULL,
                Freight NUMERIC(25) DEFAULT 0 NOT NULL,
                TotalDue NUMERIC(25) DEFAULT 0 NOT NULL,
                Comment VARCHAR(MAX),
                rowguid VARCHAR(MAX) NOT NULL,
                ModifiedDate DATETIME NOT NULL,
